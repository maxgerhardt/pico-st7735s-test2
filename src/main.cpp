...
// use ARDUINO PIN NUMBERS (plain integers)
// SPI bus is board-default one.
#define TFT_CS        10
...
void hscrolltest() 
{
  char message [] = "In a village of La Mancha, the name of which I have no desire\
  to call to mind, there lived not long since one of those gentlemen that keep a lance\
